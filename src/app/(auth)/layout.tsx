export default function AuthLayout({
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-gradient-to-br from-gin-bg-app via-gin-bg-header/40 to-gin-bg-app p-3 sm:p-4 relative overflow-hidden">
